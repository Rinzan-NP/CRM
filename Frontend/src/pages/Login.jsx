      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <div className="flex justify-center">
            {/* Grey dummy profile icon */}
            <svg
              className="h-16 w-16 rounded-full mx-auto bg-gray-200"
              viewBox="0 0 40 40"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <circle cx="20" cy="20" r="20" fill="#E5E7EB" />
              <ellipse cx="20" cy="16" rx="7" ry="7" fill="#9CA3AF" />
              <path
                d="M32 32c0-6.627-5.373-10-12-10s-12 3.373-12 10"
                fill="#9CA3AF"
              />
            </svg>
          </div>
